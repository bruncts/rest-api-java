package com.restspringboot.unittests.mapper;
...
import com.restspringboot.unittests.mapper.mocks.MockPerson;
...
public class DozerConverterTest {
    ...
    public void parseEntityListToVOListTest() {
        List<PersonVO> outputList = DozerMapper.parseList(inputObject.mockEntityList(), PersonVO.class);
    ...
    public void parserVOListToEntityListTest() {
        List<Person> outputList = DozerMapper.parseList(inputObject.mockVOList(), Person.class);
